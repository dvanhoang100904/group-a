        ...
        <div class="col-md-8 col-lg-9">
          <div class="document-preview-card">
            ...
            <div class="preview-container">
              ...
              <iframe v-if="getPreviewSource()" :src="getPreviewSource()" class="pdf-viewer"></iframe>

              <!-- Image preview (fallback) -->
              <div v-else-if="isImage(currentVersion?.file_name)" class="image-preview">
                <img :src="currentVersion?.file_url" alt="Preview" class="img-fluid" @error="handleImageError" />
              </div>
