...
@section('content')
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h3><i class="bi bi-person-circle"></i> Danh sách tài liệu</h3>
            <!-- Nút mở modal upload -->
                        ...
                        @forelse ($documents as $doc)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('documents.edit', $doc->document_id) }}" Xem trước tài liệu
                                        class="btn btn-sm btn-outline-warning">Edit</a>
                                    <form method="POST" action="{{ route('documents.destroy', $doc->document_id) }}"
                                        class="d-inline">
                                        @csrf @method('DELETE')
                                        <button type="submit" class="btn btn-sm btn-outline-danger"
                                            onclick="return confirm('Xóa tài liệu này?')">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        @empty
